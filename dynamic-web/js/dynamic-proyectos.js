...
var actionOnClick = function ( e ) {
  ...
  sessionStorage.setItem('miembro_index', proyecto_index);
	...
	if ($('.idioma-cambia').attr('idioma') == 'en') {
		window.location = 'https://languagecreativityandidentity.jesuarva.com/ficha-proyecto.html?idioma=en&proyecto_title='+proyecto_title+'&proyecto_index='+proyecto_index;
	} else {
		window.location = 'https://languagecreativityandidentity.jesuarva.com/ficha-proyecto.html?proyecto_title='+proyecto_title+'&proyecto_index='+proyecto_index;
	}
